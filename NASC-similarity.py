...
@File    ：NASC-similarity.py
@Author  ：Mingtong Zhang
@Date    ：2025/12/12 15:29 
'''
import pickle
import time
import os
...
parser = get_test_parser(case='NASC', channel=channel, version=None, train_config_number=train_config_number, test_config_number=test_config_number,
...
if __name__ == '__main__':
    ...
    model = NASC(num_layers=args.num_layers, src_vocab_size=num_vocab, tgt_vocab_size=num_vocab, model_dim=args.d_model, channel_dim=args.d_channel,
