...
from utils.utils_for_NA_DeepSC import na_decode
...
parser = get_test_parser(case='NA-DeepSC', channel=channel, version=None, train_config_number=train_config_number, test_config_number=test_config_number,
