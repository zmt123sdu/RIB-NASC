...
from utils.utils_for_NASC import train_step, eval_step
...
parser = get_train_parser(case='NASC', channel=channel, version=None, config_number=config_number)
