...
@File    ：RIB-DeepSC-bleu.py
@Author  ：Mingtong Zhang
@Date    ：2025/12/12 8:21 
'''
import pickle
import time
...
from utils.utils_for_RIB_DeepSC import greedy_decode
...
parser = get_test_parser(case='RIB-DeepSC', channel=channel, version=version, train_config_number=train_config_number, test_config_number=test_config_number,
